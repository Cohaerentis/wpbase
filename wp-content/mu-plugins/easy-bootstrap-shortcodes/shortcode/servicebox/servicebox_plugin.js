...
function create_oscitas_servicebox(pluginObj){
    ...
    <div id="osc-servicebox-scroll"><table id="oscitas-table" class="form-table">\
            ...
            <tr>\
            <?php // AEA - Rename 'class' parameter by 'css_class' ?>
				<th><label for="oscitas-servicebox-css_class">Custom Class:</label></th>\
				<td><input type="text" name="line" id="oscitas-servicebox-css_class" value=""/><br />\
				</td>\
			</tr>\
		</table></div>\
		<p class="submit">\
    ...
    form.find('#oscitas-servicebox-submit').click(function(){
        ...
        options= ['icon','icon_size','iconbg_size','iconbg_radius','margin_bottom','margin_top','iconbgcolor','iconcolor','headingtype','heading','css_class'];
