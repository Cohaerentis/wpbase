...
class cmb_Meta_Box_types {
	...
	public static function text_date_timestamp( $field, $meta ) {
		...
		echo '<input class="cmb_text_small cmb_datepicker" type="text" name="', $field['id'], '" id="', $field['id'], '" value="', ! empty( $meta ) ? date( 'd\/m\/Y', $meta ) : $field['default'], '" />', self::desc();
	}
	...
	public static function text_datetime_timestamp( $field, $meta, $object_id ) {
		...
		echo '<input class="cmb_text_small cmb_datepicker" type="text" name="', $field['id'], '[date]" id="', $field['id'], '_date" value="', ! empty( $meta ) ? date( 'd\/m\/Y', $meta ) : $field['default'], '" />';
