...
});e(".cmb_datepicker").each(function(){e("#"+jQuery(this).attr("id")).datepicker({/*AEA*/dateFormat:'dd/mm/yy'});});e("#ui-datepicker-div").wrap('<div class="cmb_element" />');if(typeof jQuery.wp==="object"&&typeof jQuery.wp.wpColorPicker==="function"){e("input:text.cmb_colorpicker").wpColorPicker();
