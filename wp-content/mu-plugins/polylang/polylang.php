...
// AEA - Workaround to get correct MU-Plugins url
// define('POLYLANG_URL', plugins_url('/' . basename(POLYLANG_DIR)));
define('POLYLANG_URL', plugins_url('/' . basename(POLYLANG_DIR), POLYLANG_DIR));
...
add_action('init', 'load_polylang');

// AEA - Activate is called in each request when reside in mu-plugin
// new Polylang();
$tn_pl = new Polylang();
global $tn_pl;
